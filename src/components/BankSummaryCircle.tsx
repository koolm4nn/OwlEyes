...
export default function BankSummaryCircle({bank}:{ bank: BankSummary}){
    return (
        <button>
            <div className={`${bank.balance < 0? "bg-red-100" : "bg-green-100"} shadow-sm ${bank.balance < 0? "shadow-red-600/80" : "shadow-green-600/80"} w-24 h-24 flex text-center items-center justify-center  p-12 rounded-full`}>
                <div>
